...
// changes to the model data (ex: arr) after the filter has been applied, will be triggring
// the filter again, unless 'pure' property of this pipe is set to false
@Pipe({
  name: 'filter',
  pure: false
})
